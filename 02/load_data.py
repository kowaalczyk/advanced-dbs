...
from pydblp.db import insert_publication_data
...
n_processes = max(16, cpu_count()*2)
...
def load_dblp(
    ...
    for event, node in t:
        if event == pulldom.START_ELEMENT:
            ...
            if n_parsed_publications % 2**3 == 0:
